    ...
    <div class="container-fluid px-4 px-md-5 py-5">
          ...
          <div class="card border-0 liquid-glass-card">
            <div class="liquid-glass-card-hover">
              <div class="card-body p-5">
                ...
                <p class="card-text fs-5">
                  通过建立全面、准确、及时的热梗数据库，我们希望帮助用户更好地理解当代网络文化，
                  促进不同年龄层、不同背景人群之间的沟通与理解。
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-4 mb-4">
          <div class="card border-0 liquid-glass-card h-100 feature-card">
            <div class="liquid-glass-card-hover">
              <div class="card-body p-4">
                <div class="feature-icon bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mb-3 mx-auto">
          ...
          <div class="card border-0 liquid-glass-card h-100 feature-card">
            <div class="liquid-glass-card-hover">
              <div class="card-body p-4">
                ...
                <h3 class="card-title text-center">实时更新</h3>
                <p class="card-text text-center text-white-50">
                  紧跟网络热点，第一时间收录最新出现的热词热梗
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="card-body p-4">
                <div class="feature-icon bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mb-3 mx-auto">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                    <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.533-.634.87-1.01z"/>
                  </svg>
                </div>
          ...
          <div class="contact-info liquid-glass-card d-inline-block p-4">
            ...
            <p class="mb-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-square-dots me-2" viewBox="0 0 16 16">
                ...
                <path d="M5 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
              </svg>
              微信公众号：何意味.com
            </p>
          </div>
